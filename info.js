let info = {
  ...
  description:
    "Balaj Here, I am a focused and result oriented Computer Science graduate from Bilkent University (Ankara, Turkey) working as a Machine Learning Engineer.\
    I am captivated by technology that makes an impact and changes the world for the better. Deeply interested in Entrepreneurship and AI for good, \
    and open to all opportunities that allow me to learn, grow and step into unchartered territories.<br><br>\
    For the past few years, I have been tinkering around machine learning.\
    More specifically, systems to detect and segment objects, models that make the most efficient use of data, and agents that learn through reinforcement are domains I enjoy exploring.<br><br>\
    I have worked with various technologies and organizations in fields ranging from Full Stack Development to Machine Learning Engineering, \
    and have deeply enjoyed solving interesting and challenging problems.",
  links: {
